...
var swfobject=function(){
    console.log("1111")
    var b="undefined",Q="object",n="Shockwave Flash",p="ShockwaveFlash.ShockwaveFlash",P="application/x-shockwave-flash",m="SWFObjectExprInst",
        j=window,K=document,T=navigator,o=[],N=[],i=[],d=[],J,Z=null,M=null,l=null,e=false,A=false;
    var h=function(){
    ...
    var L=function(){
        ...
        if(h.ie&&h.win){
            try{
                ...
                J=C("__ie_ondomload");if(J){I(J,"onreadystatechange",S)
                }
            } catch(q){
        ...
        if(h.webkit&&typeof K.readyState!=b){
            Z=setInterval(function(){
                if(/loaded|complete/.test(K.readyState)){E()}},10)
        }
    ...
    function k(w){
        ...
        if(u){
            ...
            U({
                data:w.expressInstall,id:m,width:w.width,height:w.height},{flashvars:r},x
            )}
    }
    function O(t){
        if(h.ie&&h.win&&t.readyState!=4){
            var r=a("div");t.parentNode.insertBefore(r,t);
            r.parentNode.replaceChild(G(t),r);
            t.style.display="none";
            var q=function(){t.parentNode.removeChild(t)};I(j,"onload",q)
        }else{
    ...
    function c(t){
        ...
        q[0]=parseInt(q[0],10);q[1]=parseInt(q[1],10)||0;q[2]=parseInt(q[2],10)||0;
